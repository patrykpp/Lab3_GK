// Zadanie1_Lab3.cpp : Defines the entry point for the console application.
...
const GLint pierwsza = pow(2.0, 13);
const GLfloat druga = pow(2.0, 12);  // Dla N = 13
const GLdouble trzecia = pow(2.0, 11);
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("Zadanie 1 - Lab 3");
