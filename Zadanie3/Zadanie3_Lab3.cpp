// Zadanie 3 lab3.cpp : Defines the entry point for the console application.
//
...
void GenerateTextures()
{
	...
	// wczytanie tekstury Pluton utworzonej ze zdjęć sondy Magellan
	...
	glGenTextures(1, &Pluton);

	// dowiązanie stanu tekstury
	glBindTexture(GL_TEXTURE_2D, Pluton);
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("Zadanie 3 LAB3");
